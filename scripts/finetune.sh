...
load_model_name=./log/Pet,Cell,Automotive,Tools,Toys,Sports/ckpt_b1024_lr1e-3_seqrec,seqimage/pretrain_baseline/checkpoint-26100
...
do
    ...
    OUTPUT_DIR=./log/$Datasets/finetune_baseline
    mkdir -p $OUTPUT_DIR
