...
load_model_name=./log/Pet,Cell,Automotive,Tools,Toys,Sports/ckpt_b1024_lr1e-3_seqrec,seqimage/pretrain_v4/checkpoint-26100
...
do
    ...
    OUTPUT_DIR=./log/$Datasets/finetune_v4
    mkdir -p $OUTPUT_DIR
