...
def parse_dataset_args(parser):
    ...
    # 索引版本选择: baseline, v1, v2, v3, v4
    parser.add_argument("--index_version", type=str, default="baseline", 
                        choices=["baseline", "v1", "v2", "v3", "v4"],
                        help="Index version: baseline, v1 (low-rank), v2 (post-quant), v3 (pre-quant+low-rank), v4 (pre-quant+gating+low-rank)")
    parser.add_argument("--index_file", type=str, default=".index_lemb_{version}.json", 
                        help="the item indices file (use {version} as placeholder)")
    parser.add_argument("--image_index_file", type=str, default=".index_vitemb_{version}.json", 
                        help="the image item indices file (use {version} as placeholder)")
